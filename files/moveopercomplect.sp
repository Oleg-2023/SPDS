...
begin
  ...
  /**/
  /*Âñòàâëÿåì âñå îïåðàòèâíûå ôàéëû â òàáëèöó ôàéëû*/
  ...
  DO  BEGIN
    ...
    --Âñòàâëÿåì âñå îïåðàòèâíûå ôàéëû îòïðàâêè â òàáëèöó îòïðàâîê
     FOR SELECT o.name, o.ftype, o.fdata, o.createtime, o.opertime,  o.operator_id, o.fsize
        ...
        END
    --Óäàëÿåì âñå îïåðàòèâíûå ôàéëû îòïðàâêè äëÿ òåêóùåãî îïåðôàéëà
    DELETE FROM OPEROUTFILES WHERE operfile_id=:operfile_id;
  END
  --Óäàëÿåì âñå îïåðàòèâíûå ôàéëû äëÿ îïåðêîìïëåêòà
